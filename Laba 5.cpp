...
Student Vlados = {"Vlados", "1", {{4, 2, 5}, {5, 4, 5}, {3, 4, 3}}, {"Math", "English", "History"}};
Student Shef = {"Shef", "2", {{4, 3, 5}, {5, 4, 2}, {2, 4, 3}}, {"Math", "English", "History"}};
Student Igorek = {"Igorek", "1", {{5,5,5}, {5, 5, 5}, {5,5,5}}, {"Math", "English", "History"}};
Student Egor = {"Egor", "2", {{5, 5, 5}, {5,5,5}, {5,5,5}}, {"Math", "English", "History"}};
Student Vovchik = {"Vovchik", "1", {{4, 2, 4}, {3, 4, 2}, {3, 4, 2}}, {"Math", "English", "History"}};
int main()
{

    vector<Student> students = {Vlados, Shef, Igorek, Egor, Vovchik};
